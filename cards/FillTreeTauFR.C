{
  ...
  //observables ********************** 
  //string obs[6]={"","","","","",""};
  an.dp.setObservables("tauPtLIsoJetVeto");
  ...
  Nm1Var.push_back( "opposite charge" ); 
  ...
  KFactors [ "ZJets_2l" ] = 1.;
  KFactors [ "WJets_ln" ] = 1.099; //OS -> 0.939, SS-> w=1.099
