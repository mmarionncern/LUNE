{
  ...
  LumisXS [ "rpvstop_LQD321_Stop200_chargino" ] = 17.4;
  LumisXS [ "rpvstop_LQD321_Stop300_chargino" ] = 1.89;
  LumisXS [ "rpvstop_LQD321_Stop400_chargino" ] = 0.342;
  LumisXS [ "rpvstop_LQD321_Stop500_chargino" ] = 0.082;
  LumisXS [ "rpvstop_LQD321_Stop600_chargino" ] = 0.0235;
  LumisXS [ "rpvstop_LQD321_Stop700_chargino" ] = 0.00761;
  LumisXS [ "rpvstop_LQD321_Stop800_chargino" ] = 0.00269;
  LumisXS [ "rpvstop_LQD321_Stop900_chargino" ] = 0.00101;

  LumisXS [ "../etauv12/rpvstop_LQD321_Stop300_chargino" ] = 1.89;
  LumisXS [ "../etauv12/rpvstop_LQD321_Stop400_chargino" ] = 0.342;
  LumisXS [ "../etauv12/rpvstop_LQD321_Stop500_chargino" ] = 0.082;
  LumisXS [ "../etauv12/rpvstop_LQD321_Stop600_chargino" ] = 0.0235;
  ...
  if( an.isInitStatus() ) {
    ...
    // // // // // // // // // // // //norm
    an.anConf.addSample( "OCS 88.3 ttbSH",      "t#bar{t}",  kOrange-2 );
    ...
    an.anConf.addSample( "Z1Jets_2l"  ,       "Z+jets",    kBlue-9 );
    an.anConf.addSample( "Z2Jets_2l"  ,       "Z+jets",    kBlue-9 );
    an.anConf.addSample( "Z3Jets_2l"  ,       "Z+jets",    kBlue-9 );
    an.anConf.addSample( "Z4Jets_2l"  ,       "Z+jets",    kBlue-9 );
    ...
    // an.anConf.addSample( "TTbarJets"  ,    "ftSH",    kGreen+2 );
    // // an.anConf.addSample( "TTbarJets_1l"  ,    "ftSH",    1 );
    // // an.anConf.addSample( "TTbarJets_had"  ,   "ftSH",    1 );
    // an.anConf.addSample( "W1Jets_ln"  ,       "ftSH",    2 );
    // an.anConf.addSample( "W2Jets_ln"  ,       "ftSH",    2 );
    // an.anConf.addSample( "W3Jets_ln"  ,       "ftSH",    2 );
    // an.anConf.addSample( "W4Jets_ln"  ,       "ftSH",    2 );
    // an.anConf.addSample( "Z1Jets_2l"  ,       "ftSH",    3 );
    // an.anConf.addSample( "Z2Jets_2l"  ,       "ftSH",    3 );
    // an.anConf.addSample( "Z3Jets_2l"  ,       "ftSH",    3 );
    // an.anConf.addSample( "Z4Jets_2l"  ,       "ftSH",    3 );

    // an.anConf.addSample( "ghost TTbarJets"  ,       "ftSH",    2 );
    // an.anConf.addSample( "ghost WJets_ln"  ,       "ftSH",    2 );
    // an.anConf.addSample( "ghost ZJets_2l"  ,       "ftSH",    3 );
    
    // //norm
    an.anConf.addSample( "OCS 65.7 ftSH",   "fake #tau",   kViolet+1 );
    
    
    an.anConf.addSample( "rpvstop_LQD321_Stop300_chargino", "#tilde{t} 300 GeV sig", kBlack);
    //an.anConf.addSample( "rpvstop_LQD321_Stop400_chargino", "#tilde{t} 400 GeV sig", kBlack);
    //an.anConf.addSample( "rpvstop_LQD321_Stop500_chargino", "#tilde{t} 500 GeV sig", kGreen+1);
    // an.anConf.addSample( "rpvstop_LQD321_Stop600_chargino", "#tilde{t} 600 GeV sig", kBlue+1);
    // an.anConf.addSample( "rpvstop_LQD321_Stop700_chargino", "#tilde{t} 700 GeV sig", kBlue+1);
    // an.anConf.addSample( "rpvstop_LQD321_Stop800_chargino", "#tilde{t} 800 GeV sig", kBlue+1);
    // an.anConf.addSample( "rpvstop_LQD321_Stop900_chargino", "#tilde{t} 900 GeV sig", kBlue+1);
