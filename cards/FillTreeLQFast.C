{
  ...
  //observables ********************** 
  //string obs[6]={"","","","","",""};
  an.dp.setObservables("nJetAdv");//STVsMassFinal
  
  //Binning & title ************************* Binning & titre
  string yTitle="number of events";
  int binning=1;
  int addBinBkg=1; //BinB = binning*AddBin
  double rangeY[2]={0,0.3};
  ...
  if( an.isInitStatus() ) {
    ...
    // an.anConf.addSample( "TTbarJets_2l_scDo" ,  "t#bar{t} down",  kRed+1 );
    // an.anConf.addSample( "TTbarJets_2l_scUp" ,  "t#bar{t} up",  kViolet-9 );
    ...
    // // // // // // // //norm
    // an.anConf.addSample( "OCS 105.6 ttbSH",      "t#bar{t}",  kOrange-2 );
    
    //norm mains el
    an.anConf.addSample( "OCS 1444.86 ttbSH",      "t#bar{t}",  kOrange-2 );
    ...
    //an.anConf.addSample( "OCS 124.2 ftSH",   "fake #tau",   kViolet+1 );
     ...
     //main sel
     // an.anConf.addSample( "OCS 1254 ftSH",   "fake #tau",   kViolet+1 );
    
     // an.anConf.addSample( "CS 277 QCD",   "QCD",   kMagenta+3 );

    //all fake taus
    an.anConf.addSample( "CS 1531 FakeQCD",   "fake #tau",   kViolet+1 );
    
    // // // an.anConf.addSample( "LQ400_tb" , "LQ 400 GeV sig",    kGreen+2 );
    // // // an.anConf.addSample( "LQ450_tb" , "LQ 450 GeV",    kGreen+2 );
     //an.anConf.addSample( "LQ500_tb" , "LQ 500 GeV sig",    kBlack );
    ...
    // // an.anConf.addSample( "LQ900_tb" , "LQ 900 GeV",    kGreen+2 );
