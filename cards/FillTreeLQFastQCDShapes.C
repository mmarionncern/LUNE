{
  ...
  string dir="LQ2012/etauv11_1"; //etauv11_1
  string tName="tree";
  ...
  //observables ********************** 
  //string obs[6]={"","","","","",""};
  an.dp.setObservables("nJetAdv");//STVsMassFinal //STbjetVar
  ...
  //  an.advOptions(false,false,"GLOUBI");
  an.advOptions(false,false);
  ...
  if( an.isInitStatus() ) {
    ...
    //an.anConf.addSample( "CS 23.6 QCD",   "QCD",   kMagenta+3 );
