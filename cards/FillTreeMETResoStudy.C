{
  ...
  //observables ********************** 
  //string obs[6]={"","","","","",""};
  an.dp.setObservables("pfT1PhiredUpara");//STVsMassFinal
  ...
  an.resoStudy("METTYPE"); //mva, mvaU, noPU, Calo or pfT1
  ...
  if( an.isInitStatus() ) {
   ...
   an.anConf.addSample( "DoubleMu_D_190456_208686_3"   , "data", 0 );
    ...
    // an.anConf.addSample( "DoubleEle_D_190456_208686_1"   , "data", kOrange-2 ); 
